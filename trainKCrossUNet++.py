...
from UnetPlusPlusModel import NestedUNet
...
if __name__ == "__main__":
    ...
    for fold, (train_ids, val_ids) in enumerate(kfold.split(np.arange(NBSAMPLES))):
        ...
        net = NestedUNet(num_classes=4).to(device)
        ...
        for epoch in tqdm(range(NB_EPOCHS)):
            ...
            if avg_val_loss < best_val_loss:
                ...
                torch.save(net.state_dict(), f'/scratch/das6859/UNetVGNNCAMUS/weights/unet++ES_fold{fold+1}_best.pt')
