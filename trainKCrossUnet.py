...
from basicUnetModel import UNet
    ...
    for fold, (train_ids, val_ids) in enumerate(kfold.split(np.arange(NBSAMPLES))):
        ...
        for epoch in tqdm(range(NB_EPOCHS)):
            ...
            if avg_val_loss < best_val_loss:
                ...
                torch.save(net.state_dict(), f'/scratch/das6859/UNetVGNNCAMUS/weights/basicunetES_fold{fold+1}_best.pt')
...
=======
    print('Finished Training')
>>>>>>> d4715e50f7e653546ed0bc089ee6f85c1e69e653
